...
RUN \
 ...
 apt-get update && \
 apt-get -y install --no-install-recommends deluged deluge-web deluge-console python3-libtorrent mediainfo libchromaprint-tools inotify-tools openjdk-8-jre-headless && \
